...
$(function() {
  var bookmark = {
    ...
    {
      name: '坤坤模拟',
      link: 'https://kuesdt.github.io/ikun/',
      box_shadow: '#F18033',
      icon: 'img/ikun.png',
    },
    {
      name: '少妇贴膜',
      link: 'https://kuesdt.github.io/EatKano/',
      box_shadow: '#11B063',
      icon: 'img/sf.png',
    },
     {
      name: '短小唐网',
      link: 'https://kuesdt.github.io/01/',
      box_shadow: '#11B063',
      icon: 'img/dxt.png',
    },
     {
      name: '开发者网',
      link: 'https://kuesdt.github.io/Jay/',
      box_shadow: '#11B063',
      icon: 'img/zjl.png',
    },
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "Kuesdt";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "Kuesdt";
}
